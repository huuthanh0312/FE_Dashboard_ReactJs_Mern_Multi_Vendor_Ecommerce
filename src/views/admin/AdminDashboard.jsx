...
import { FaEye, FaShoppingCart, FaUser, FaUsers } from 'react-icons/fa'
import {
  MdCurrencyExchange,
...
const AdminDashboard = () => {
  ...
  const { totalSale, totalProduct, totalOrder, totalSeller, recentMessages, recentOrders } =
      ...
      <div className="px-2 pb-6 md:px-5">
        ...
        <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="flex justify-between items-center p-5 bg-white rounded-md gap-3 shadow-lg md:hover:scale-105 hover:shadow-indigo-200">
            ...
            <div className="w-[45px] h-[45px] justify-center items-center flex rounded-full border-2 border-yellow-450 shadow-lg">
          ...
          <div className="flex justify-between items-center p-5 bg-white rounded-md gap-3 shadow-lg md:hover:scale-105 hover:shadow-indigo-200">
            ...
            <div className="w-[45px] h-[45px] justify-center items-center flex rounded-full border-2 border-blue-450 shadow-lg">
          ...
          <div className="flex justify-between items-center p-5 bg-white rounded-md gap-3 shadow-lg md:hover:scale-105 hover:shadow-indigo-200">
            ...
            <div className="w-[45px] h-[45px] justify-center items-center flex rounded-full border-2 border-rose-450 shadow-lg">
              <FaUsers size="26px" />
            </div>
          </div>
          ...
          <div className="flex justify-between items-center p-5 bg-white rounded-md gap-3 shadow-lg md:hover:scale-105 hover:shadow-indigo-200">
            ...
            <div className="w-[45px] h-[45px] justify-center items-center flex rounded-full border-2 border-green-450 shadow-lg">
          ...
          <div className="w-full lg:w-5/12 py-6 lg:py-0 ">
            <div className="w-full bg-white p-4 shadow-lg rounded-md hover:shadow-indigo-200">
              <div className="flex justify-between items-center pb-3 text-lg font-semibold text-[#383737] ">
                ...
                <Link to="/admin/chat-seller" className="hover:text-blue-500">
                  View All
                </Link>
              </div>
        ...
        <div className="w-full p-4 bg-white shadow-lg rounded-md text-[#383737] hover:shadow-indigo-200">
          <div className="flex justify-between items-center pb-3 text-lg font-semibold">
            ...
            <Link to="/admin/orders" className="hover:text-blue-500d">
              View All
            </Link>
          </div>
