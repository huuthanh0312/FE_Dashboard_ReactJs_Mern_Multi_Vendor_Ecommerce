...
const OrderDetails = () => {
  ...
  const handleStatusOrder = (e) => {
    dispatch(
      updateAdminStatusOrder({ orderId: normalizedOrderId, info: { status: e.target.value } })
    )
    ...
    <div>
      <div className="px-2 md:px-5 pb-6 ">
        ...
        <div className="w-full p-5 bg-white rounded-md shadow-md hover:shadow-indigo-200">
          ...
          {/* end */}
          <div className="lg:p-4 text-[#383737]">
              ...
              <div className="lg:w-[60%] w-full mt-4 ml:mt-0 lg:pl-3">
                <div className="w-full flex flex-col bg-[#eeeeee] rounded-md shadow">
                  {order?.suborders?.map((o, i) => (
                    <div key={i} className="flex flex-col px-4 pt-4 pb-2 ">
                      <div className="flex justify-start items-center gap-3 border-b-2 border-blue-500 pb-2">
