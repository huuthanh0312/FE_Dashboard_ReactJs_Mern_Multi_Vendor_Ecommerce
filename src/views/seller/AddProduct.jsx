      ...
      <div className="px-2 lg:px-5 pb-6 ">
        ...
        <div className="w-full p-4 bg-white rounded-md shadow-md hover:shadow-indigo-200">
          <div className="flex justify-between items-center text-[#383737] pb-1 border-b-2">
            ...
            <Link className="px-6 py-1 font-semibold text-blue-500 rounded-md shadow-md border-blue-500 border-[2px] my-2 hover:bg-blue-500 hover:text-white">
              All Product
            </Link>
          </div>
          {/* table */}
              ...
              <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 sm:gap-6 gap-3 w-full mb-4 pt-2">
                ...
                {imageShow.map((img, i) => (
                  <div className="h-[180px] relative rounded-md shadow-lg border sm:hover:scale-105 hover:shadow-indigo-200">
                    <label htmlFor={i}>
                      <img src={img.url} alt="" className=" h-full rounded-md" />
                    </label>
                    {/* change image */}
                    <input
                      type="file"
